        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.expr_type.as_ref() {
            match v {
                ...
                logical_expr_node::ExprType::NamedStruct(v) => {
                    struct_ser.serialize_field("namedStruct", v)?;
                }
            }
        }
        struct_ser.end()
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "namedStruct" | "named_struct" => Ok(GeneratedField::NamedStruct),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
...
;
                        ...
                        GeneratedField::NamedStruct => {
                            if expr_type__.is_some() {
                                return Err(serde::de::Error::duplicate_field("namedStruct"));
                            }
                            expr_type__ = map.next_value::<::std::option::Option<_>>()?.map(logical_expr_node::ExprType::NamedStruct)
;
                        }
                    }
                }
...
impl serde::Serialize for NamedStructNode {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("datafusion.NamedStructNode", len)?;
        if !self.exprs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for NamedStructNode {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = NamedStructNode;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct datafusion.NamedStructNode")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<NamedStructNode, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("datafusion.NamedStructNode", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for StructTuple {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("datafusion.StructTuple", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if let Some(v) = self.expr.as_ref() {
...
impl<'de> serde::Deserialize<'de> for StructTuple {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = StructTuple;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct datafusion.StructTuple")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<StructTuple, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut name__ = None;
        ...
        deserializer.deserialize_struct("datafusion.StructTuple", FIELDS, GeneratedVisitor)
    }
}
