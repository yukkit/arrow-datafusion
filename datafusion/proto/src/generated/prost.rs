...
pub mod logical_expr_node {
    ...
    pub enum ExprType {
        ...
        NamedStruct(super::NamedStructNode),
    }
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct NamedStructNode {
    #[prost(message, repeated, tag = "1")]
    pub exprs: ::prost::alloc::vec::Vec<StructTuple>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl AggregateMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            AggregateMode::PartialMerge => "PARTIAL_MERGE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "PARTIAL_MERGE" => Some(Self::PartialMerge),
            _ => None,
        }
    }
}
